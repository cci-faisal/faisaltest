...
<!--  End Left Column-->
<div id="CentreColumn" style="margin-top: 60px;">
    <div style="float:left; width:460px;">
	<?php
        if (defined('SITE_DESIGNATION')){ 
           echo SITE_DESIGNATION;
        }
        $content= html_entity_decode($page_content);
        $content_replaced = replace_tokens($content);
        echo str_replace('&','&amp;',$content_replaced);
    ?>
    </div>
    <div id="grants-loans-calculator" style="float:left; width:460px; padding-top:8px; padding-bottom:2px;">
        <?php 
...
<?php
	...
	$sqlInterviews = "SELECT * FROM gl_story where st_status='Active' and st_datetime <= '".$mySqlDateTime."' ORDER BY RAND() LIMIT 5";
